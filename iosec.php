<?php
/**
 * @package IOSEC Anti Flood Security Gateway Module
 * @version 1.9.0
 */
/*
 Name: IOSEC Anti Flood Security Gateway Module
 URI: https://sourceforge.net/projects/iosec/
Description: Anti Flood Security Gateway Module
Version: 1.9.0
Author: Gokhan Muharremoglu
Author URI: http://www.iosec.org
License: GPL2
*/
...
*/
 error_reporting(0);
 /////////////////////////////////// CONFIGURATION MENU ///////////////////////////////////////////////
 $use_captcha                       = ""; //If you want to use reCAPTCHA set value to "y" otherwise leave it empty (default is "y").
 ...
 $refresh_timeout                   = 23; //Suspended Process Timeout value in seconds.
 ...
 $debug_info                        = ""; //If you want to show debug info then set value to "y" otherwise leave it empty.
 ...
 $use_whitelist                     = "y"; //If you want to use whitelist set value to "y" otherwise leave it empty (default is empty).
 $use_excluded                      = ""; //If you want to use excluded file list, set this value to "y" otherwise leave it empty (default is empty).
 $use_refblocker 					= "y"; // New: - use ref blocker - blacklisted referer will automatically see IOSEC page wait
 ...
 if ($interval >= $refresh_timeout) {
     die("IOSEC - You can not use an \$interval value greater than or equal to \$refresh_timeout value.");
 }
 $banlisttemp = '/home/www/lib/security/iosec_admin/banlisttemp';
 $whitelist   = '/home/www/lib/security/iosec_admin/whitelist';
 $excluded    = '/home/www/lib/security/iosec_admin/excluded';
 $ips         = '/home/www/lib/security/iosec_admin/ips';
 $banlist     = '/home/www/lib/security/iosec_admin/banlist';
 $reflist 	  = '/home/www/lib/security/iosec_admin/reflist';  // list with bad referers
 ...
 if ($use_refblocker == "y"){
    ...
    $read_reflist 	= file($reflist);
	
	foreach ($read_reflist as $ref) {
		...
		$pattern = "/$site/i";
        if (preg_match ($pattern, $HTTP_REFERER)) {
           // echo "DEBUG: Client ip will be set temporary ban<br>";
			fwrite($htaccess, $CLIENT_IP . "|" . (time() + microtime()) . "\n");
			break;
        }
 ...
 function getRealIP()
 {
  // taken: http://stackoverflow.com/questions/5421144/php-get-real-ip-proxy-detection
  $proxy_headers = array(
                          'CLIENT_IP', 
                          'FORWARDED', 
                          'FORWARDED_FOR', 
  ...
  foreach($proxy_headers as $proxy_header){
	...
	/* Behandle mehrere IPs in einer Anfrage(z.B.: X-Forwarded-For: client1, proxy1, proxy2) */
	  ...
	  $pos_temp = stripos($proxy_header_temp, ':');
      if( $pos_temp !== FALSE) {
		$proxy_header_temp = substr($proxy_header_temp, 0, $pos_temp); /* Entferne den Port */
	  }
                ...
                <div align="center">
                    ...
                    <table border="0" width="336" id="table1" cellspacing="1"  height="66">
                        <tr>
                            ...
                            <br>
                            IOSec.org Anti Flood Security Gateway Module<br>
                            </font>
                    ...
                    ~ Please Wait <b><span id="timer"></span></b> Second(s) ~<br> &nbsp;
					If the Timer doesnt move or After That Timespan you can Reload the Page<br>
					</font>
...
<font face="Arial" style="font-size: 8pt" color="#33ff00"><?php
                 echo base64_decode("Q29weXJpZ2h0IElPU2VjLm9yZyAyMDEyIEdva2hhbiBNdWhhcnJlbW9nbHU=");
?></font>
</table>
<p>&nbsp;</p>
